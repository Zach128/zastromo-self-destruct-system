...
namespace TestWinBackGrnd.Svg
{
    ...
    public class SvgParser
    {
        ...
        public static Bitmap GetBitmapFromSVGFile(string filePath)
        {
        ...
        /// <summary>
        /// Converts an SVG object to a Bitmap image.
        /// </summary>
        /// <param name="filePath">The contents of the SVG file.</param>
        /// <returns>Returns the converted Bitmap image.</returns>
        public static Bitmap GetBitmapFromSVG(SvgDocument doc)
        {
            Bitmap bmp = doc.Draw();
            return bmp;
        }
        ...
        /// <summary>
        /// Gets a SvgDocument for manipulation using the contents of an SVG file.
        /// </summary>
        /// <param name="data">The final contents of the SVG file.</param>
        /// <returns>Returns the SVG Document.</returns>
        public static SvgDocument GetSvgDocumentFromString(string data)
        {
            if (data == null) return null;
            XmlDocument xml = new XmlDocument();
            xml.LoadXml(data);
            SvgDocument document = SvgDocument.Open(xml);
            return AdjustSize(document);
        }
